namespace CSharp.Rop.GenericResult
{
    public partial struct Result
    {
        internal static class Messages
        {
            ...
            public static readonly string ValidValueObjectCannotBeNull =
                "You attempted to create a success result, but a null value object was passed to the constructor.";

            public static readonly string HasValueIsProvidedForFailure =
                "You attempted to create a failure result, which must not have an value, but hasValue was passed to the constructor.";
