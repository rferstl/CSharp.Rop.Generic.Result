...
namespace CSharp.Rop.GenericResult.Tests
{
    public class EnsureMethodTests
    {
        ...
        {
            var sut = GenericResult.Result.Failure("some error");
        ...
        {
            var sut = GenericResult.Result.Success();
        ...
        {
            var sut = GenericResult.Result.Failure<TimeSpan>("some error");
        ...
        {
            var sut = GenericResult.Result.Success(10101);
        ...
        {
            var sut = GenericResult.Result.Success(.03m);
